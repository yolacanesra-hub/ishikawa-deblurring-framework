...
% Early stop marker
plot(ax4, [stop_iter stop_iter], ylim_temp(ax4, PSNR), '--k', 'LineWidth', 1.0);
hold(ax4, 'off');
...
if P.export_plots
    ...
    print(fig, [base_name '.tif'], '-dtiff', ['-r' num2str(P.export_dpi)]);
    print(fig, [base_name '.png'], '-dpng',  ['-r' num2str(P.export_dpi)]);
    print(fig, [base_name '.eps'], '-depsc', '-painters');
